...
const notion = new Client({ auth: secret_lq0k769HrOJypi7le18mTeLJSoTbn4FrtXjaKHbgbek })
const databaseId = process.env.NOTION_DATABASE_ID || '681336d5644b47b3bfdb021e34e82c89'
